...
export const THREAD_AGENT_BASE_INSTRUCTIONS = [
  ...
  'CURRENT-THREAD SCOPE: Action items are limited to requests and decisions made in this thread conversation. Document notes and every other thread, open or closed, are reference evidence only. Never copy, carry over, merge, or independently derive their action items into this list. Include work supported by that context only when this thread itself explicitly requests or decides it.',
