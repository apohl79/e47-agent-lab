...
target account, forwards completed agent messages, accepts messages sent from
that account in Element as ordinary turns, and routes explicitly correlated
replies to `request_user_input` prompts.
