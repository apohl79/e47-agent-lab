...
| [Project Context Curator](plugins/project-context-curator/README.md) | `5.7.1` | Durable project knowledge with audit and graph-assisted retrieval. | Xedoc, Codex, Claude Code |
