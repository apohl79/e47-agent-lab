...
| `project-context-curator` | `2.0.1` | Canonical project and XDG-scoped context with filtered hybrid retrieval. | `plugins/project-context-curator` | Codex, Claude Code |
