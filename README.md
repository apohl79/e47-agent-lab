...
| [Inline Discussion](plugins/inline-discussion/README.md) | `2.0.0` | Keep document editing, focused AI side threads, and main-agent updates in one view. | Codex, Claude Code, Xedoc |
